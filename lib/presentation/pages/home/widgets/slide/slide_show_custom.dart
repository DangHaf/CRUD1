...
import 'package:template/presentation/pages/home/widgets/slide/indicator.dart';

class SlideshowCustom extends StatefulWidget {
  const SlideshowCustom({
    Key? key,
    ...
    this.indicatorLeftPadding,
    this.indicatorRightPadding,
  }) : super(key: key);

  /// The widgets to display in the [SlideshowCustom].
  ///
  /// Mainly intended for image widget, but other widgets can also be used.
  final List<Widget> children;

  /// Width of the [SlideshowCustom].
  final double width;

  /// Height of the [SlideshowCustom].
  final double height;

  /// The page to show when first creating the [SlideshowCustom].
  ...
  /// LeftPadding to Indicator.
  final double? indicatorLeftPadding;

  /// RightPadding to Indicator.
  final double? indicatorRightPadding;

  @override
  SlideshowCustomState createState() => SlideshowCustomState();
}

class SlideshowCustomState extends State<SlideshowCustom> {
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            left: widget.indicatorLeftPadding,
