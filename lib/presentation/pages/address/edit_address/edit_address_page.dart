              ...
              body: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: CustomButton(
                      label: 'address_007'.tr,
                      callBack: () {
                        if (controller.address.isDefault) {
                          IZIAlert().error(message: 'address_019'.tr);
                          return;
                        }
                        Get.dialog(
                          DialogConfirm(
                            icon: ImagesPath.icActionDelete,
                            title: 'address_017'.tr,
                            content: 'address_018'.tr,
